-- Las tareas terminadas son inmutables. Si una reserva se cancela después de haber
-- resuelto una alerta, se crea un nuevo ciclo de alerta en vez de reabrir el anterior.
