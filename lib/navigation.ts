...
export const appModules: AppModule[] = [
  ...
  { href: "/proveedores", label: "Proveedores", stage: "07", owner: "Operaciones", description: "Base de proveedores por destino, contacto, condiciones, estado y riesgo.", status: "ready_demo" },
  { href: "/compras", label: "Compras", stage: "08", owner: "Operaciones", description: "Facturas proveedor, revisión manual y conciliación operativa.", status: "ready_demo" },
  { href: "/facturacion", label: "Pagos y facturación", stage: "09", owner: "Facturación", description: "Cobros manuales y borradores fiscales para sincronización conservadora.", status: "ready_demo" },
  { href: "/integraciones", label: "Integraciones", stage: "10", owner: "Admin", description: "Outbox, reintentos, entradas externas y tareas programadas.", status: "prepared" },
  { href: "/cierre", label: "Cierre operativo", stage: "11", owner: "Dirección", description: "Checklist final de contrato, pago, proveedores y notas.", status: "ready_demo" },
  { href: "/seguridad", label: "Seguridad", stage: "12", owner: "Admin", description: "Roles, permisos y auditoría antes de activar datos reales.", status: "prepared" },
  { href: "/ajustes/tipos-servicio", label: "Tipos de servicio", stage: "13", owner: "Admin", description: "Catálogo ampliable de servicios para presupuestos.", status: "ready_demo" },
];
