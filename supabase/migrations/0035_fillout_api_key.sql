-- Keep the Fillout REST API key separate from the optional inbound webhook secret.
-- No existing secret is copied because the legacy slot may contain a real webhook token.
