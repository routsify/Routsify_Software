...
export const appModules: AppModule[] = [
  ...
  { href: "/compras", label: "Compras", stage: "06", owner: "Operaciones", description: "Facturas proveedor, revisión manual y conciliación operativa.", status: "ready_demo" },
  { href: "/facturacion", label: "Pagos y facturación", stage: "07", owner: "Facturación", description: "Cobros manuales y borradores fiscales para sincronización conservadora.", status: "ready_demo" },
  { href: "/integraciones", label: "Integraciones", stage: "08", owner: "Admin", description: "Outbox, reintentos, entradas externas y tareas programadas.", status: "prepared" },
  { href: "/cierre", label: "Cierre operativo", stage: "09", owner: "Dirección", description: "Checklist final de contrato, pago, proveedores y notas.", status: "ready_demo" },
  { href: "/seguridad", label: "Seguridad", stage: "10", owner: "Admin", description: "Roles, permisos y auditoría antes de activar datos reales.", status: "prepared" },
  { href: "/ajustes/tipos-servicio", label: "Tipos de servicio", stage: "11", owner: "Admin", description: "Catálogo ampliable de servicios para presupuestos.", status: "ready_demo" },
];
