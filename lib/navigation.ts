...
export const appModules: AppModule[] = [
  ...
  { href: "/clientes", label: "Clientes", stage: "02", owner: "Ventas", description: "Ficha única del cliente: deduplicación, origen, datos fiscales, historial, expedientes, documentación y estado Holded.", status: "ready_demo" },
  { href: "/expedientes", label: "Expedientes", stage: "03", owner: "Operaciones", description: "Centro del flujo: viaje, estado, bloqueo, próxima acción, timeline, viajeros, documentos, contrato, pago y cierre.", status: "ready_demo" },
  ...
  { href: "/informes", label: "Informes", stage: "06", owner: "Dirección", description: "Funnel, origen, pipeline, margen previsto/real, desviaciones, proveedores y Holded.", status: "ready_demo" },
  { href: "/ajustes", label: "Ajustes", stage: "07", owner: "Admin", description: "Configuración global, integraciones, fiscalidad, márgenes, roles, OCR, retención y auditoría.", status: "prepared" },
];
