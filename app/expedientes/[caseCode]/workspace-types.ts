...
export type Traveler = { id: string; traveler_type?: string; first_name?: string; last_name?: string; birth_date?: string | null; nationality?: string | null; document_country?: string | null; document_number?: string | null; document_expires_at?: string | null; review_status?: string | null };
export type DocumentRow = { id: string; title?: string | null; file_name?: string | null; type?: string | null; status?: string | null; mime_type?: string | null; created_at?: string | null };
export type TaskRow = { id: string; title?: string; status?: string; priority?: string; due_at?: string | null };
